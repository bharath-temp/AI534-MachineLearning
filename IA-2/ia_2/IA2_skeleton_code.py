...
for lambda_val in lambda_array:
    ...
    print("Sparsity for lambda " + str(lambda_val) + ": " + str(sparsity))
    train_output.append(L2_trained_acc)
    val_output.append(L2_valed_acc)
    
#L2_trained_weights, L2_trained_acc, L2_valed_acc = LR_L2_train(pre_proc_train_data, pre_proc_val_data, 100)
...
fig, ax = plt.subplots()
train1 = ax.bar(x - width/2, sparsities, width, label = 'Sparsities')
